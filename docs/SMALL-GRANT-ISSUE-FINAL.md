...
Repo: TBD  
Demo: local MVP includes polished role-switching lesson UI, deterministic access tests, browser wallet Lit route, and diagnostics.
...
- Hosted demo: TBD if deployment is available before review
